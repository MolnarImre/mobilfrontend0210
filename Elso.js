  ...
  render(){
    ...
    return(
      <View style={{flex: 1, paddingTop:20, backgroundColor:'white'}}>
        ...
        onPress={async ()=>this.vasarlas(item.alkatresz_id)} 
        >
        <Text style={{color:"white",fontWeight:"bold",fontSize:15}}>Megvétel</Text>
      </TouchableOpacity>

      <TextInput
        style={{color:"Light", fontSize:15,marginLeft:20,marginTop:10,height:100}}
