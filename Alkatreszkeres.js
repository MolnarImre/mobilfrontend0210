...
fetch( Ip.ipcim+"alkatreszkereses", {
    method: "POST",
  ...
  render(){
    ...
    return(
      <View style={{flex: 1, paddingTop:20}}>
          {/*-------------------------------------------------------------------------------------- keresés */}
          <Text style={{color:"Light", fontSize:15,marginLeft:10,marginTop:30}}>Add meg a keresendő alkatrész nevét:</Text>
          <TextInput
        style={{color:"Light", fontSize:15,marginLeft:10,marginTop:10}}
        placeholder="típus megadása megadása (Pontosan írd be nevét)"
      ...
      >
        ...
        <FlatList
          ...
          <Image  source={{uri:  Ip.ipcim+item.alkatresz_kep}} style={{width:400,height:300,marginLeft:"auto",marginRight:"auto",marginBottom:25,resizeMode:'contain'}} />
